...
from SSync.modules import networks, utils
from SSync.utils import config_as_kwargs, make_build_fn
...
class MLPDecoder(nn.Module):
    ...
    def forward(self, slots: torch.Tensor) -> Dict[str, torch.Tensor]:
        ...
        return {"reconstruction": recon, "masks": masks.squeeze(-1), "alpha": alpha.squeeze(-1)}
